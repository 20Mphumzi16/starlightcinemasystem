...
public class Helper {
    ...
    public static boolean isValidDoB(LocalDate date) {
        return date.isAfter(LocalDate.now());
    }
    public static boolean isValidDateTime(LocalDateTime dateTime)
    {
        return dateTime.isBefore(LocalDateTime.now().minusDays(1));
    }
    public static boolean isFutureDateTime(LocalDateTime dateTime)
    {
        return dateTime.isAfter(LocalDateTime.now().plusHours(1));
    }
