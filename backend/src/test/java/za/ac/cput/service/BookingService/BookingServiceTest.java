...
class BookingServiceTest {
    ...
    static void setUp() {
        ...
        movie1= MovieFactory.createMovie("Fantastic 4",new byte[0],LocalDate.of(2025,1,17),genres1,160,rating1,"The fantstic 4 is back on track to save the world.");
        movie2=MovieFactory.createMovie("Expandables",new byte[0],LocalDate.of(2024,5,6),genres2,92,rating2,"Dom is kidnapped and the Expandables are born again.");
        movie3=MovieFactory.createMovie("Love Island",new byte[0],LocalDate.of(2021,12,15),genres3,90,rating3,"TLove is in the air in this city.");
    ...
    void create() {
        ...
        Booking createdBooking1=bookingService.create(booking1);
    ...
    @Order(3)
    void update() {
        Booking bookingToUpdate=new Booking.BookingBuilder().copy(booking2).setStatus(BookingStatus.Canceled).build();
    ...
    @Order(4)
    void delete() {
        boolean deleted=bookingService.delete(3L);
        assertTrue(deleted);
