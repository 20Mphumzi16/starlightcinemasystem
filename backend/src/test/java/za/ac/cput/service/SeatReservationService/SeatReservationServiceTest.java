...
class SeatReservationServiceTest {
    ...
    @Autowired
    public SeatReservationServiceTest(SeatReservationService seatReservationService) {
    ...
    static void setUp() {
        ...
        booking1=BookingFactory.createBooking(show1,customer1,BookingStatus.Confirmed,LocalDateTime.now(),600);
    ...
    void create() {
        ...
        SeatReservation createdSeatReservation1 = seatReservationService.create(seatReservation1);
        assertNotNull(createdSeatReservation1);
        System.out.println(createdSeatReservation1);

        SeatReservation createdSeatReservation2 = seatReservationService.create(seatReservation2);
        assertNotNull(createdSeatReservation2);
        System.out.println(createdSeatReservation2);

        SeatReservation createdSeatReservation3 = seatReservationService.create(seatReservation3);
        assertNotNull(createdSeatReservation3);
        System.out.println(createdSeatReservation3);
    ...
    void read() {
        ...
        SeatReservation readSeatReservation1 = seatReservationService.read(1L);
        assertNotNull(readSeatReservation1);
        System.out.println(readSeatReservation1);
    ...
    void update() {
        ...
        SeatReservation seatReservationToUpdate = new SeatReservation.SeatReservationBuilder().copy(seatReservation2).setStatus(SeatStatus.RELEASED).build();
        SeatReservation updatedSeatReservation = seatReservationService.update(seatReservationToUpdate);
        assertNotNull(updatedSeatReservation);
        System.out.println(updatedSeatReservation);
    }
    ...
    void delete() {
        ...
        boolean deleted = seatReservationService.delete(3L);
        assertTrue(deleted);
    ...
    @Test
    @Order(5)
    void getAllSeatReservations() {

        List<SeatReservation> allSeatReservations = seatReservationService.getAllSeatReservations();
        assertNotNull(allSeatReservations);
        System.out.println(allSeatReservations);
    }
}