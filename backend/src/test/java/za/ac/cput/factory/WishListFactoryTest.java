...
class WishListFactoryTest {
    ...
    static void setUp() {
        ...
        movie2=MovieFactory.createMovie("Expandables",new byte[0],LocalDate.of(2023,6,22),genres2,92,rating2,"Dom is kidnapped and the Expandables are born again.");
        movie3=MovieFactory.createMovie("Love Island",new byte[0],LocalDate.of(2025,7,20),genres3,90,rating3,"TLove is in the air in this city.");
